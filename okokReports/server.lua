...
function hasPermission(id)
	...
	if Config.ESX then
		...
		if playerGroup ~= nil and playerGroup == "owner" or playerGroup == "superadmin" or playerGroup == "helper" or playerGroup == "admin" or playerGroup == "headadmin" or playerGroup == "mod" then 
			staff = true
		end
	else
