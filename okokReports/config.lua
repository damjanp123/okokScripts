...
Config.FeedbackClientCommand = 'pomoc' -- The command that the players use to report something

Config.FeedbackAdminCommand = 'pomoclista' -- The command that the admins use to check the pendent feedbacks list
